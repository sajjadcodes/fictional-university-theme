...
const googeMap = new _modules_GoogleMap__WEBPACK_IMPORTED_MODULE_3__["default"]();
const customSearch = new _modules_search__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
class Search {
  ...
  getResults() {
    // $.getJSON('http://fictional-university.local/wp-json/wp/v2/posts?search=wordpress', (resultData) =>{
    //     alert(resultData[0].title.rendered);
    //     alert("This is");
    // });
    alert(universityData.root_url); //   $.getJSON(universityData.root_url + "/wp-json/wp/v2/posts?search=" + this.searchField.val()  ,(results) =>{
    //     alert("working");
    //     this.resultsDiv.html(`
    //       <div class="row">
    //             <div class="one-third">
    ...
    //               ${results.length ? '<ul class="link-list min-list">': '<p>No Search Result Found</p>'}
